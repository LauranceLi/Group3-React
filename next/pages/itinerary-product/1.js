...
export default function List() {
  ...
  const updateDestinationOptions = useCallback((selectedRegion) => {
    let options = []
    switch (selectedRegion) {
      case '中南美洲':
        options = ['秘魯', '智利', '阿根廷', '古巴', '墨西哥', '玻利維亞']
        break
      case '歐洲':
        options = ['西班牙', '葡萄牙', '法國', '奧地利&捷克', '鐵道之旅']
        break
      case '日本':
        options = ['鐵道之旅', '九州', '名古屋', '沖繩', '福岡', '東京']
        break
      default:
        options = []
    }
  ...
  useEffect(() => {
    ...
    getProducts(params)
  }, [page, perpage, orderby, titleLike, country, area, priceGte, priceLte, days])
      ...
      <div>
        ...
        <select
          ...
          onChange={(e) => {
            ...
            updateDestinationOptions(selectedCountry)
          }}
        >
